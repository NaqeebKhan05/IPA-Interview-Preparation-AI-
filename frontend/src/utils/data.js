...
export const CARD_BG = [
    ...
    {id: 9, bgcolor: "linear-gradient(135deg, #f0ecff 0%, #f7fcfa 100%)"},  
...
export const  APP_FEATURES = [
    {
     ...
     description: "Get Interview Prep tailored just for you with our AI-powered platform."   
    },
    {
     id: "02",
    ...
    {
     id: "04",
     title: "Understand the 'Why?' behind your answers",
     description: "Get Interview Prep tailored just for you with our AI-powered platform."   
    },
    {
     id: "05",
