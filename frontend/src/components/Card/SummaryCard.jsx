...
const SummaryCard = ({
  ...
  return (
    <div
      className="bg-white border border-gray-300/40 rounded-xl p-2 overflow-hidden hover:shadow-xl shadow-gray-100 relative group cursor-pointer"
      onClick={onSelect}
    >
      <div
      ...
      >
        ...
        <button
          className="hidden group-hover:flex items-center gap-2 text-xs text-rose-500 font-medium bg-rose-50 px-3 py-1 rounded text-nowrap border border-rose-100 hover:bg-rose-200 cursor-pointer absolute top-0 right-0"
          onClick={(e) => {
            e.stopPropagation();
            onDelete();
          }}
